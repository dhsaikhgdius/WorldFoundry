"""Module for base_models -> diffusion_model -> video -> lvdm -> modules -> networks -> openaimodel3d.py functionality."""
...
class UNetModel(nn.Module):
    ...
    def __init__(self,
        ...
        Args:
            ...
            use_image_attention: VideoCrafter/T2V-Turbo alias for image_cross_attention.
            default_fs: The default fs.
            fs_condition: The fs condition.
            fps_cond: VideoCrafter/T2V-Turbo alias for fs_condition.
            time_cond_proj_dim: Optional T2V-Turbo guidance embedding dimension.
            motion_cond_proj_dim: Optional T2V-Turbo motion guidance embedding dimension.
            temporal_transformer_depth: Optional T2V-Turbo temporal transformer depth.
            record_attn_probs: Accepted for official T2V-Turbo configs; no-op here.
        """
    ...
    def forward(
        ...
        **kwargs,
        ...
        Args:
            ...
            fs: The fs.
            fps: Alias for fs used by VideoCrafter/T2V-Turbo.
            timestep_cond: Optional guidance-scale embedding used by T2V-Turbo.
            motion_cond: Optional motion-guidance embedding used by T2V-Turbo.
        """
        b,_,t,_,_ = x.shape
