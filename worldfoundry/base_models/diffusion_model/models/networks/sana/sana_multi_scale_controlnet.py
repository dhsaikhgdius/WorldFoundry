...
"""Module for base_models -> diffusion_model -> image -> sana -> diffusion -> model -> nets -> sana_multi_scale_controlnet.py functionality."""
...
class ControlSanaMSBlock(Module):
    """Control sana ms block implementation."""
