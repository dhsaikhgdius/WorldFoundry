...
"""Module for base_models -> diffusion_model -> image -> sana -> diffusion -> model -> nets -> sana_multi_scale_video_camctrl.py functionality."""
...
class DeltaActionEmbedder(nn.Module):
    """Delta action embedder implementation."""
