...
# DUSt3R model class
# --------------------------------------------------------
"""Module for base_models -> three_dimensions -> general_3d -> monst3r -> dust3r -> model.py functionality."""
...
# Kept self-contained in this MonST3R fork copy (no cross-copy imports).
_CHECKPOINT_LITERAL_NAMES = {"inf": inf, "nan": float("nan")}


class _CheckpointLiteralNames(ast.NodeTransformer):
    """Rewrite bare ``inf``/``nan`` names used by MonST3R args strings into constants."""
...
def load_model(model_path, device, verbose=True):
    ...
    # which under torch>=2.6 defaults to weights_only=True and fails on real MonST3R
...
class AsymmetricCroCo3DStereo (
    ...
    def _encode_image_pairs(self, img1, img2, true_shape1, true_shape2):
        """Helper function to encode image pairs.

        Args:
            img1: The img1.
            img2: The img2.
            true_shape1: The true shape1.
            true_shape2: The true shape2.
        """
    ...
    def _encode_symmetrized(self, view1, view2):
        """Helper function to encode symmetrized.
