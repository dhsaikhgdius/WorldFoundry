"""Unified synchronous session for Self-Gradient-Forcing."""
...
class NativeSelfGradientForcingTrainingSession(NativeDMDTrainingSession):
    """Reuse the scalable DMD data, accumulation, and checkpoint cadence."""

    step_event_schema = "worldfoundry-self-gradient-forcing-step-event"
    ...
    def __init__(
        ...
        *,
        ...
        if not isinstance(engine, NativeSelfGradientForcingTrainEngine):
            raise TypeError("engine must be NativeSelfGradientForcingTrainEngine")
        super().__init__(
            engine,
            dataloader,
            progress,
...
__all__ = ["NativeSelfGradientForcingTrainingSession"]
