"""Native AnyFlow on-policy DMD and fresh fake-score objectives."""
...
from .config import AnyFlowOnPolicyConfig, AnyFlowPretrainConfig
...
from .rollout import anyflow_rollout, sample_rollout_choice
...
class NativeAnyFlowOnPolicyLossAdapter:
    """Own randomized-rollout DMD, FAR pixel cotraining, and fake regression."""
    ...
    def __init__(
        ...
        *,
        ...
        self.pixel = NativeAnyFlowPretrainLossAdapter(
            student,
            AnyFlowPretrainConfig(
                flow_map=config.flow_map,
                far=config.far,
                bidirectional_modeling_probability=(config.bidirectional_modeling_probability),
...
__all__ = ["NativeAnyFlowOnPolicyLossAdapter"]
