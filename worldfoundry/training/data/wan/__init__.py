...
_EXPORTS = {
    ...
    "prepare_wan_training_cache": ".training_cache",
    "prepare_wan_training_cache_from_audits": ".training_cache",
    "wan_cache_contract_digest": ".contracts",
    "wan_checkpoint_asset_digest": ".contracts",
    "wan_latent_normalization_digest": ".contracts",
}
