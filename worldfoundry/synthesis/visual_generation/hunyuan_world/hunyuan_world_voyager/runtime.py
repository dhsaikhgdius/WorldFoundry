...
from worldfoundry.synthesis.visual_generation.hunyuan_world.hunyuan_world_voyager.constants import (
    NEGATIVE_PROMPT,
    NEGATIVE_PROMPT_I2V,
    PRECISION_TO_TYPE,
    PROMPT_TEMPLATE,
...
from worldfoundry.synthesis.visual_generation.hunyuan_world import (
    load_hunyuan_world_state_dict as load_state_dict,
)
...
class HunyuanWorldVoyagerRuntime:
    def __init__(
        self,
        args,
        vae,
        ...
        if args.i2v_mode:
            ...
            if args.use_lora:
                from worldfoundry.synthesis.visual_generation.hunyuan_world.hunyuan_world_voyager.utils.lora_utils import (
...
def load_runtime(*args, **kwargs) -> HunyuanWorldVoyagerRuntime:
    return HunyuanWorldVoyagerRuntime.from_pretrained(*args, **kwargs)
