...
from worldfoundry.base_models.diffusion_model.models.autoencoders.hunyuan_video import load_hunyuan_video_vae
...
def load_vae(vae_type,
    ...
    """Load GameCraft's HunyuanVideo VAE through the canonical model component."""
    if vae_path is None:
        vae_path = f"{model_base}/{VAE_PATH[vae_type]}"
    return load_hunyuan_video_vae(
        vae_type,
        vae_precision,
        sample_size,
        vae_path,
