...
from worldfoundry.core.process import read_text_tail, run_logged_subprocess, synthesis_timeout_seconds
        ...
        **kwargs: Any,
        ...
        with tempfile.TemporaryDirectory(prefix="worldfoundry_lingbot_v2_") as temp_raw:
            ...
            completed = run_logged_subprocess(
                ...
                timeout=synthesis_timeout_seconds(float(options["timeout_seconds"])),
            )
            if completed.returncode != 0:
                tail = read_text_tail(stderr_path, max_lines=200)
                raise RuntimeError(
