...
"""Module for base_models -> diffusion_model -> video -> wan -> wan_2p2 -> utils -> utils.py functionality."""
...
def best_output_size(w, h, dw, dh, expected_area):
    ...
    Args:
        ...
        dw: The dw.
        dh: The dh.
        expected_area: The expected area.
    """
    # float output size
    ratio = w / h
