...
仓库外 gate report
`${WORLDFOUNDRY_HOME}/wan21-real-dmd-gate-20260730f/gate_result.json`
...
仓库外 gate report
`${WORLDFOUNDRY_HOME}/wan21-real-dmd-gate-20260809-official-resume-oracle/gate_result.json`
...
仓库外 gate report
`${WORLDFOUNDRY_HOME}/wan21-real-flow-grpo-gate-20260801f/gate_result.json`
...
仓库外报告
`${WORLDFOUNDRY_HOME}/anyflow-real-far-gate-20260809a/summary.json`
...
仓库外报告
`${WORLDFOUNDRY_HOME}/anyflow-real-bidirectional-gate-20260809a/summary.json`
