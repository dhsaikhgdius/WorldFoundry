...
from worldfoundry.synthesis.visual_generation.lingbot.lingbot_world_runtime.distributed.util import init_distributed_group

# === Configuration ===
IMAGE_PATH = os.getenv("WORLDFOUNDRY_LINGBOT_IMAGE", "./src/worldfoundry/data/test_cases/test_image_case1/ref_image.png")
PRETRAINED_MODEL_PATH = os.getenv("WORLDFOUNDRY_LINGBOT_CKPT_DIR", "robbyant/lingbot-world-base-cam")
