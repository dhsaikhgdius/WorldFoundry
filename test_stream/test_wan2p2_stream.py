...
from worldfoundry.base_models.diffusion_model.video.wan_2p2.configs import WAN_CONFIGS
...
initial_image_path: Optional[str] = "./data/test_cases/test_image_case1/ref_image.png" # "path to image"
