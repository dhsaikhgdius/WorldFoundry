...
The `[ui]` extra pins `gradio>=5.50,<6` and `starlette<1.0` on purpose: Gradio 6 / Starlette ≥1.0 remove `FastAPI.add_event_handler` and break `workspace_app`. Keep those bounds if you mirror the extra into your own requirements files.
