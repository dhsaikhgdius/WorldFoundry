...
def test_sana_recipe_binds_the_checkpoint() -> None:
...
def test_sana_sprint_recipes_pin_independent_student_and_teacher_assets() -> None:
    expected = {
...
def test_wan_recipe_binds_every_large_asset_and_tokenizer_binary() -> None:
