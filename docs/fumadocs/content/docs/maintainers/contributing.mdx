...
- **Catalog homepage coverage** — after model/benchmark catalog YAML changes, refresh with `cd docs/fumadocs && npm run catalog:generate`, then `npm run catalog:check`.
