...
Primary scorecard key: `chronomagic_score`.
...
- Full official core runs require a user-provided MTScore checkpoint and OpenAI credentials for GPT4o-MTScore (a hosted judge); without them only the CHScore-family components run.
- Leaderboard parity requires the complete ChronoMagic prompt set, generated videos, MTScore, GPT4o-MTScore, UMT fields, and the official submission protocol.
