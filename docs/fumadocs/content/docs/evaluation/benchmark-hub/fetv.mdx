...
- The default in-tree component covers CLIPScore; full metric execution still requires the BLIP/FID/FVD metric packages and reference frame assets.
- Full leaderboard validation requires generated videos for the complete FETV prompt set plus the FETV metric dependency setup.
