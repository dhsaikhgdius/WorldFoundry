...
Primary scorecard key: `vbench_plus_plus_average`.
...
- Bounded official GPU validation covers the long-video variant only; full I2V, long-video, and trustworthiness suite coverage is still pending.
- Leaderboard parity requires the complete official variant suites and generated artifacts.
