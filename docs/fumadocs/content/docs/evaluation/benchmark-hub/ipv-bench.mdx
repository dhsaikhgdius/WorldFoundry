...
Primary scorecard key: `ipv_bench_average`.
...
- The in-tree surface normalizes official annotations, judge scores, or understanding predictions; it does not run the official judges itself.
- Full leaderboard validation still requires official annotations or judge outputs plus generated videos for the official suite.
