...
Primary scorecard key: `memobench_average`.
...
- Step 1 official execution requires the complete MemoBench dataset assets; Object Revisit Score requires SAM-3 assets; VQA requires Gemini or compatible VLM credentials, which is a hosted API call.
